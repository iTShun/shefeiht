...
<script>
    ...
    function search_totaltable(index, datas = {}) 
	{
		...
		var arr = { c_id:'gettotaltable', pos:'#headingTwo', index:index };
	...
	$(document).ready(function(){
		...
		$(function() {
			document.getElementsByName('table_time')[0].value=getDate();
						...
						<div id="collapseOne" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne">
						  	<div class="panel-body">
								<form id="total_table_add" action="php/control.php?c_id=totaltableadd" method="post" enctype="multipart/form-data">
									<label for="file">1、文件名:</label>
									<span><input type="file" name="file" accept=".XLS,.xlsx" id="file" /></span>
									<br/>
									<label for="file">2、信息:</label><br/>
									<input type="text" name="table_add_name" placeholder="名字" size="11" />
									<input type="text" name="table_add_phone" placeholder="电话" size="11" />
									<input type="text" name="table_add_wechat" placeholder="微信号" size="11" />
									<br/>
									<br/>
									<label for="file">附加信息:</label><br/>
									...
									&nbsp;&nbsp;
									<input type="datetime-local" name="table_time" />
									&nbsp;&nbsp;
									<label> <input type="checkbox" name="iswechat">&nbsp;微信</label>
									<br/>
									<br/>
						...
						<div id="collapseTwo" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
						  	<div class="panel-body">
						  		<form action="#">
									...
									<input type="button" class="btn btn-primary" onclick="search_totaltable(1, { u_id:search_id.value, name:search_name.value, phone:search_phone.value, wechat:search_wechat.value, status:search_status.value, source:search_source.value, start_date:search_start_pickdate.value, start_time:search_start_picktime.value, end_date:search_end_pickdate.value, end_time:search_end_picktime.value });" value="查询" />
								</form>
								<br/>
								<table class="table table-bordered table-striped no-margin grd_tble">
									<thead>
										<tr> <th>ID</th> <th>名字</th> <th>电话</th> <th>微信号</th> <th>状态</th> <th>地址</th> <th>描述</th> <th>来源</th> <th>时间</th> </tr>
									</thead>
